(function(){"use strict";class fe{constructor(e,t){this.hoveredEl=null,this.highlightOverlay=null,this.onPick=e,this.onCancel=t,this.handleMouseOver=this.handleMouseOver.bind(this),this.handleMouseOut=this.handleMouseOut.bind(this),this.handleClick=this.handleClick.bind(this),this.handleKeyDown=this.handleKeyDown.bind(this)}start(){document.body.classList.add("pb-picking-active"),document.addEventListener("mouseover",this.handleMouseOver,!0),document.addEventListener("mouseout",this.handleMouseOut,!0),document.addEventListener("click",this.handleClick,!0),document.addEventListener("keydown",this.handleKeyDown,!0)}stop(){document.body.classList.remove("pb-picking-active"),document.removeEventListener("mouseover",this.handleMouseOver,!0),document.removeEventListener("mouseout",this.handleMouseOut,!0),document.removeEventListener("click",this.handleClick,!0),document.removeEventListener("keydown",this.handleKeyDown,!0),this.clearHighlight()}highlight(e){if(this.clearHighlight(),e.closest("#punchbug-root"))return;this.hoveredEl=e;const t=e.getBoundingClientRect(),i=document.createElement("div");i.id="pb-highlight-overlay",i.setAttribute("data-punchbug-ignore","true"),i.style.cssText=["position:fixed",`top:${t.top}px`,`left:${t.left}px`,`width:${t.width}px`,`height:${t.height}px`,"pointer-events:none","z-index:2147483645","outline:2px solid hsl(348,100%,52%)","outline-offset:2px","border-radius:2px","background:hsla(348,100%,52%,0.07)","box-sizing:border-box"].join(";"),document.body.appendChild(i),this.highlightOverlay=i}clearHighlight(){var e;(e=this.highlightOverlay)==null||e.remove(),this.highlightOverlay=null,this.hoveredEl=null}handleMouseOver(e){const t=e.target;t&&!t.closest("#punchbug-root")&&t!==this.highlightOverlay&&this.highlight(t)}handleMouseOut(e){this.hoveredEl===e.target&&this.clearHighlight()}handleClick(e){e.preventDefault(),e.stopPropagation();const t=e.target;t&&!t.closest("#punchbug-root")&&t!==this.highlightOverlay&&(this.clearHighlight(),this.stop(),this.onPick({el:t,clientX:e.clientX,clientY:e.clientY,pageX:e.clientX+window.scrollX,pageY:e.clientY+window.scrollY}))}handleKeyDown(e){e.key==="Escape"&&(this.stop(),this.onCancel())}}async function xe(n,e){const t=await fetch(`${n}/api/embed/report`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)});if(!t.ok){const i=await t.json().catch(()=>({}));throw new Error(i.error||"Failed to submit report")}return t.json()}class ye{constructor(e,t){this.screenshotFull="",this.shadow=e,this.opts=t,this.overlay=this.render(t)}setScreenshot(e,t){var a;this.screenshotFull=e;const i=this.shadow.getElementById("pb-sc-loader"),r=this.shadow.getElementById("pb-sc-wrap"),o=this.shadow.getElementById("pb-sc-img");if(!e){i==null||i.remove();return}const s=t||e;o&&(o.src=s),i&&(i.style.display="none"),r&&(r.style.display="block"),e&&((a=this.shadow.getElementById("pb-sc-expand"))==null||a.addEventListener("click",()=>{this.openLightbox(e)}))}render(e){var b;const t=document.createElement("div");t.className="pb-overlay";const i=document.createElement("div");i.className="pb-panel";const r=document.createElement("div");r.className="pb-panel-header",r.innerHTML=`
    ...
    `;const o=document.createElement("div");o.className="pb-panel-body",e.columns.length>0&&`${e.columns.map(p=>`<option value="${p.id}">${p.name}</option>`).join("")}`;const s=e.tags.length>0?`<div class="pb-field">
    ...
    `,s.appendChild(a),s.appendChild(l),o.appendChild(s),this.shadow.appendChild(o),this.overlay=o,(b=this.shadow.getElementById("pb-tpanel-close"))==null||b.addEventListener("click",()=>this.close()),o.addEventListener("click",p=>{p.target===o&&this.close()}),Promise.all([fetch(`${i}/api/embed/task/${e.id}?key=${encodeURIComponent(r)}`).then(p=>p.ok?p.json():Promise.reject()),fetch(`${i}/api/embed/columns?key=${encodeURIComponent(r)}`).then(p=>p.ok?p.json():[]),fetch(`${i}/api/embed/members?key=${encodeURIComponent(r)}`).then(p=>p.ok?p.json():[])]).then(([p,g,E])=>{this.renderFull(l,p,g,E,t,i,r)}).catch(()=>this.renderBasic(l,e,t,i))}async patch(e,t,i,r){return fetch(`${e}/api/embed/task/${t}?key=${encodeURIComponent(i)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify(r)})}renderFull(e,t,i,r,o,s,a){var he,be,ue,me,ge;const l=t.creatorName||t.guestName||"Guest",b=t.projectSlug??o,p=i.map(c=>`<option value="${h(c.id)}"${c.id===t.columnId?" selected":""}>${h(c.name)}</option>`).join(""),g=we.map(c=>`<option value="${c}"${c===t.priority?" selected":""}>${c}</option>`).join(""),E=[`<option value=""${t.assigneeId?"":" selected"}>Unassigned</option>`,...r.map(c=>`<option value="${h(c.id)}"${c.id===t.assigneeId?" selected":""}>${h(c.name??c.id)}</option>`)].join(""),H=t.screenshotUrl?`
      <div>
      ...
      <a class="pb-view-board-btn"
         href="${s}/projects/${b}?task=${t.taskNumber}"
         target="_blank" rel="noopener noreferrer">
        View in board →
      </a>
    `;const v=this.shadow.getElementById("pb-title-display"),ae=this.shadow.getElementById("pb-title-wrap");let B=t.title;v.addEventListener("click",()=>{const c=document.createElement("input");c.type="text",c.className="pb-title-input",c.value=B,ae.replaceChildren(c),c.focus();const u=async()=>{const d=c.value.trim()||B;B=d;const m=document.createElement("h2");m.className="pb-title-display",m.id="pb-title-display",m.textContent=d,ae.replaceChildren(m),m.addEventListener("click",()=>u()),d!==t.title&&await this.patch(s,t.id,a,{title:d})};c.addEventListener("blur",u),c.addEventListener("keydown",d=>{d.key==="Enter"&&(d.preventDefault(),c.blur()),d.key==="Escape"&&(c.value=B,c.blur())})});const le=this.shadow.getElementById("pb-desc-display"),ce=this.shadow.getElementById("pb-desc-wrap");let j=t.description??"";le.addEventListener("click",()=>{const c=document.createElement("textarea");c.className="pb-desc-textarea",c.value=j,c.rows=4,ce.replaceChildren(c),c.focus();const u=async()=>{const d=c.value;j=d;const m=document.createElement("div");m.className="pb-desc-display",m.id="pb-desc-display",d?(m.style.whiteSpace="pre-wrap",m.textContent=d):m.innerHTML='<span class="pb-desc-placeholder">Click to add a description…</span>',ce.replaceChildren(m),m.addEventListener("click",()=>le.click()),d!==(t.description??"")&&await this.patch(s,t.id,a,{description:d||null})};c.addEventListener("blur",u),c.addEventListener("keydown",d=>{d.key==="Escape"&&(c.value=j,c.blur()),d.key==="Enter"&&(d.metaKey||d.ctrlKey)&&c.blur()})}),(he=this.shadow.getElementById("pb-col-select"))==null||he.addEventListener("change",c=>{const u=c.target.value;this.patch(s,t.id,a,{columnId:u||null})}),(be=this.shadow.getElementById("pb-pri-select"))==null||be.addEventListener("change",c=>{const u=c.target.value;this.patch(s,t.id,a,{priority:u})}),(ue=this.shadow.getElementById("pb-assignee-select"))==null||ue.addEventListener("change",c=>{const u=c.target.value;this.patch(s,t.id,a,{assigneeId:u||null})}),t.screenshotUrl&&((me=this.shadow.getElementById("pb-tp-expand"))==null||me.addEventListener("click",c=>{c.stopPropagation(),this.openLightbox(t.screenshotUrl)}),(ge=this.shadow.getElementById("pb-tp-sc-wrap"))==null||ge.addEventListener("click",()=>{this.openLightbox(t.screenshotUrl)}));const $=this.shadow.getElementById("pb-comment-input"),k=this.shadow.getElementById("pb-post-comment"),F=this.shadow.getElementById("pb-comments-list"),pe=this.shadow.getElementById("pb-comments-label");let de=t.comments.length;k==null||k.addEventListener("click",async()=>{const c=$==null?void 0:$.value.trim();if(!(!c||!$)){k.disabled=!0,k.textContent="Posting…";try{const u=await fetch(`${s}/api/embed/task/${t.id}/comments?key=${encodeURIComponent(a)}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({body:c,guestName:l})});if(!u.ok)throw new Error;const d=await u.json();if($.value="",de++,pe&&(pe.textContent=`Comments (${de})`),F){const m=F.querySelector(".pb-no-comments");m&&m.remove();const N=document.createElement("div");N.className="pb-comment",N.innerHTML=`
            <div class="pb-comment-meta">
          ...
          `,F.appendChild(N)}}catch{}finally{k.disabled=!1,k.textContent="Post comment"}}})}renderBasic(e,t,i,r){const o=ve[t.priority]??"#64748b";e.innerHTML=`
      ...
      <a class="pb-view-board-btn" href="${r}/projects/${i}?task=${t.id}" target="_blank" rel="noopener noreferrer">View in board →</a>
    `}openLightbox(e){const t=document.createElement("div");t.className="pb-lightbox";const i=document.createElement("img");i.className="pb-lightbox-img",i.src=e;const r=document.createElement("button");r.className="pb-lightbox-close",r.innerHTML="&#x2715;",r.addEventListener("click",()=>t.remove()),t.addEventListener("click",o=>{o.target===t&&t.remove()}),t.appendChild(r),t.appendChild(i),this.shadow.appendChild(t)}close(){var e;(e=this.overlay)==null||e.remove(),this.overlay=null}}function ke(n){return{selector:Ce(n),outerHtml:n.outerHTML.slice(0,2e3)}}function Ce(n){var i;const e=[];let t=n;for(;t&&t!==document.body&&t.nodeType===Node.ELEMENT_NODE;){let r=t.tagName.toLowerCase();if(t.id){e.unshift(`#${CSS.escape(t.id)}`);break}const o=(i=t.parentElement)==null?void 0:i.children;if(o&&o.length>1){let s=1;for(let l=0;l<o.length&&o[l]!==t;l++)o[l].tagName===t.tagName&&s++;Array.from(o).filter(l=>l.tagName===t.tagName).length>1&&(r+=`:nth-of-type(${s})`)}if(e.unshift(r),t=t.parentElement,e.length>=6)break}return e.join(" > ")||n.tagName.toLowerCase()}function Se(){const n=navigator.userAgent,{browserName:e,browserVersion:t}=$e(n),{osName:i,osVersion:r}=Le(n),o=Pe();return{browserName:e,browserVersion:t,osName:i,osVersion:r,deviceType:o,screenWidth:screen.width,screenHeight:screen.height,viewportWidth:window.innerWidth,viewportHeight:window.innerHeight,userAgent:n}}function $e(n){const e=[{name:"Chrome",pattern:/Chrome\/([0-9.]+)/},{name:"Firefox",pattern:/Firefox\/([0-9.]+)/},{name:"Safari",pattern:/Version\/([0-9.]+).*Safari/},{name:"Edge",pattern:/Edg\/([0-9.]+)/},{name:"Opera",pattern:/OPR\/([0-9.]+)/}];for(const t of e){const i=n.match(t.pattern);if(i)return{browserName:t.name,browserVersion:i[1].split(".")[0]}}return{browserName:"Unknown",browserVersion:""}}function Le(n){var e,t,i;return/Windows NT 10/.test(n)?{osName:"Windows",osVersion:"10/11"}:/Windows NT/.test(n)?{osName:"Windows",osVersion:"Other"}:/Mac OS X ([0-9_]+)/.test(n)?{osName:"macOS",osVersion:((e=n.match(/Mac OS X ([0-9_]+)/))==null?void 0:e[1].replace(/_/g,"."))??""}:/Android ([0-9.]+)/.test(n)?{osName:"Android",osVersion:((t=n.match(/Android ([0-9.]+)/))==null?void 0:t[1])??""}:/iPhone OS ([0-9_]+)/.test(n)?{osName:"iOS",osVersion:((i=n.match(/iPhone OS ([0-9_]+)/))==null?void 0:i[1].replace(/_/g,"."))??""}:/Linux/.test(n)?{osName:"Linux",osVersion:""}:{osName:"Unknown",osVersion:""}}function Pe(){const n=navigator.userAgent;return/Mobi|Android.*Mobile|iPhone|iPod/.test(n)?"mobile":/iPad|Android(?!.*Mobile)/.test(n)?"tablet":"desktop"}function Ie(n,e){if(n.match(/^[a-z]+:\/\//i))return n;if(n.match(/^\/\//))return window.location.protocol+n;if(n.match(/^[a-z]+:/i))return n;const t=document.implementation.createHTMLDocument(),i=t.createElement("base"),r=t.createElement("a");return t.head.appendChild(i),t.body.appendChild(r),e&&(i.href=e),r.href=n,r.href}const Te=(()=>{let n=0;const e=()=>`0000${(Math.random()*36**4<<0).toString(36)}`.slice(-4);return()=>(n+=1,`u${e()}${n}`)})();function w(n){const e=[];for(let t=0,i=n.length;t<i;t++)e.push(n[t]);return e}let C=null;function V(n={}){return C||(n.includeStyleProperties?(C=n.includeStyleProperties,C):(C=w(window.getComputedStyle(document.documentElement)),C))}function L(n,e){const i=(n.ownerDocument.defaultView||window).getComputedStyle(n).getPropertyValue(e);return i?parseFloat(i.replace("px","")):0}function Re(n){const e=L(n,"border-left-width"),t=L(n,"border-right-width");return n.clientWidth+e+t}function Me(n){const e=L(n,"border-top-width"),t=L(n,"border-bottom-width");return n.clientHeight+e+t}function W(n,e={}){const t=e.width||Re(n),i=e.height||Me(n);return{width:t,height:i}}function Be(){let n,e;try{e=process}catch{}const t=e&&e.env?e.env.devicePixelRatio:null;return t&&(n=parseInt(t,10),Number.isNaN(n)&&(n=1)),n||window.devicePixelRatio||1}const x=16384;function ze(n){(n.width>x||n.height>x)&&(n.width>x&&n.height>x?n.width>n.height?(n.height*=x/n.width,n.width=x):(n.width*=x/n.height,n.height=x):n.width>x?(n.height*=x/n.width,n.width=x):(n.width*=x/n.height,n.height=x))}function P(n){return new Promise((e,t)=>{const i=new Image;i.onload=()=>{i.decode().then(()=>{requestAnimationFrame(()=>e(i))})},i.onerror=t,i.crossOrigin="anonymous",i.decoding="async",i.src=n})}async function Oe(n){return Promise.resolve().then(()=>new XMLSerializer().serializeToString(n)).then(encodeURIComponent).then(e=>`data:image/svg+xml;charset=utf-8,${e}`)}async function Ue(n,e,t){const i="http://www.w3.org/2000/svg",r=document.createElementNS(i,"svg"),o=document.createElementNS(i,"foreignObject");return r.setAttribute("width",`${e}`),r.setAttribute("height",`${t}`),r.setAttribute("viewBox",`0 0 ${e} ${t}`),o.setAttribute("width","100%"),o.setAttribute("height","100%"),o.setAttribute("x","0"),o.setAttribute("y","0"),o.setAttribute("externalResourcesRequired","true"),r.appendChild(o),o.appendChild(n),Oe(r)}const f=(n,e)=>{if(n instanceof e)return!0;const t=Object.getPrototypeOf(n);return t===null?!1:t.constructor.name===e.name||f(t,e)};function Ae(n){const e=n.getPropertyValue("content");return`${n.cssText} content: '${e.replace(/'|"/g,"")}';`}function He(n,e){return V(e).map(t=>{const i=n.getPropertyValue(t),r=n.getPropertyPriority(t);return`${t}: ${i}${r?" !important":""};`}).join(" ")}function je(n,e,t,i){const r=`.${n}:${e}`,o=t.cssText?Ae(t):He(t,i);return document.createTextNode(`${r}{${o}}`)}function _(n,e,t,i){const r=window.getComputedStyle(n,t),o=r.getPropertyValue("content");if(o===""||o==="none")return;const s=Te();try{e.className=`${e.className} ${s}`}catch{return}const a=document.createElement("style");a.appendChild(je(s,t,r,i)),e.appendChild(a)}function Fe(n,e,t){_(n,e,":before",t),_(n,e,":after",t)}const q="application/font-woff",G="image/jpeg",Ne={woff:q,woff2:q,ttf:"application/font-truetype",eot:"application/vnd.ms-fontobject",png:"image/png",jpg:G,jpeg:G,gif:"image/gif",tiff:"image/tiff",svg:"image/svg+xml",webp:"image/webp"};function De(n){const e=/\.([^./]*?)$/g.exec(n);return e?e[1]:""}function z(n){const e=De(n).toLowerCase();return Ne[e]||""}function Ve(n){return n.split(/,/)[1]}function O(n){return n.search(/^(data:)/)!==-1}function We(n,e){return`data:${e};base64,${n}`}async function X(n,e,t){const i=await fetch(n,e);if(i.status===404)throw new Error(`Resource "${i.url}" not found`);const r=await i.blob();return new Promise((o,s)=>{const a=new FileReader;a.onerror=s,a.onloadend=()=>{try{o(t({res:i,result:a.result}))}catch(l){s(l)}},a.readAsDataURL(r)})}const U={};function _e(n,e,t){let i=n.replace(/\?.*/,"");return t&&(i=n),/ttf|otf|eot|woff2?/i.test(i)&&(i=i.replace(/.*\//,"")),e?`[${e}]${i}`:i}async function A(n,e,t){const i=_e(n,e,t.includeQueryParams);if(U[i]!=null)return U[i];t.cacheBust&&(n+=(/\?/.test(n)?"&":"?")+new Date().getTime());let r;try{const o=await X(n,t.fetchRequestInit,({res:s,result:a})=>(e||(e=s.headers.get("Content-Type")||""),Ve(a)));r=We(o,e)}catch(o){r=t.imagePlaceholder||"";let s=`Failed to fetch resource: ${n}`;o&&(s=typeof o=="string"?o:o.message),s&&console.warn(s)}return U[i]=r,r}async function qe(n){const e=n.toDataURL();return e==="data:,"?n.cloneNode(!1):P(e)}async function Ge(n,e){if(n.currentSrc){const o=document.createElement("canvas"),s=o.getContext("2d");o.width=n.clientWidth,o.height=n.clientHeight,s==null||s.drawImage(n,0,0,o.width,o.height);const a=o.toDataURL();return P(a)}const t=n.poster,i=z(t),r=await A(t,i,e);return P(r)}async function Xe(n,e){var t;try{if(!((t=n==null?void 0:n.contentDocument)===null||t===void 0)&&t.body)return await I(n.contentDocument.body,e,!0)}catch{}return n.cloneNode(!1)}async function Ye(n,e){return f(n,HTMLCanvasElement)?qe(n):f(n,HTMLVideoElement)?Ge(n,e):f(n,HTMLIFrameElement)?Xe(n,e):n.cloneNode(Y(n))}const Ke=n=>n.tagName!=null&&n.tagName.toUpperCase()==="SLOT",Y=n=>n.tagName!=null&&n.tagName.toUpperCase()==="SVG";async function Je(n,e,t){var i,r;if(Y(e))return e;let o=[];return Ke(n)&&n.assignedNodes?o=w(n.assignedNodes()):f(n,HTMLIFrameElement)&&(!((i=n.contentDocument)===null||i===void 0)&&i.body)?o=w(n.contentDocument.body.childNodes):o=w(((r=n.shadowRoot)!==null&&r!==void 0?r:n).childNodes),o.length===0||f(n,HTMLVideoElement)||await o.reduce((s,a)=>s.then(()=>I(a,t)).then(l=>{l&&e.appendChild(l)}),Promise.resolve()),e}function Qe(n,e,t){const i=e.style;if(!i)return;const r=window.getComputedStyle(n);r.cssText?(i.cssText=r.cssText,i.transformOrigin=r.transformOrigin):V(t).forEach(o=>{let s=r.getPropertyValue(o);o==="font-size"&&s.endsWith("px")&&(s=`${Math.floor(parseFloat(s.substring(0,s.length-2)))-.1}px`),f(n,HTMLIFrameElement)&&o==="display"&&s==="inline"&&(s="block"),o==="d"&&e.getAttribute("d")&&(s=`path(${e.getAttribute("d")})`),i.setProperty(o,s,r.getPropertyPriority(o))})}function Ze(n,e){f(n,HTMLTextAreaElement)&&(e.innerHTML=n.value),f(n,HTMLInputElement)&&e.setAttribute("value",n.value)}function et(n,e){if(f(n,HTMLSelectElement)){const t=e,i=Array.from(t.children).find(r=>n.value===r.getAttribute("value"));i&&i.setAttribute("selected","")}}function tt(n,e,t){return f(e,Element)&&(Qe(n,e,t),Fe(n,e,t),Ze(n,e),et(n,e)),e}async function nt(n,e){const t=n.querySelectorAll?n.querySelectorAll("use"):[];if(t.length===0)return n;const i={};for(let o=0;o<t.length;o++){const a=t[o].getAttribute("xlink:href");if(a){const l=n.querySelector(a),b=document.querySelector(a);!l&&b&&!i[a]&&(i[a]=await I(b,e,!0))}}const r=Object.values(i);if(r.length){const o="http://www.w3.org/1999/xhtml",s=document.createElementNS(o,"svg");s.setAttribute("xmlns",o),s.style.position="absolute",s.style.width="0",s.style.height="0",s.style.overflow="hidden",s.style.display="none";const a=document.createElementNS(o,"defs");s.appendChild(a);for(let l=0;l<r.length;l++)a.appendChild(r[l]);n.appendChild(s)}return n}async function I(n,e,t){return!t&&e.filter&&!e.filter(n)?null:Promise.resolve(n).then(i=>Ye(i,e)).then(i=>Je(n,i,e)).then(i=>tt(n,i,e)).then(i=>nt(i,e))}const K=/url\((['"]?)([^'"]+?)\1\)/g,it=/url\([^)]+\)\s*format\((["']?)([^"']+)\1\)/g,rt=/src:\s*(?:url\([^)]+\)\s*format\([^)]+\)[,;]\s*)+/g;function ot(n){const e=n.replace(/([.*+?^${}()|\[\]\/\\])/g,"\\$1");return new RegExp(`(url\\(['"]?)(${e})(['"]?\\))`,"g")}function st(n){const e=[];return n.replace(K,(t,i,r)=>(e.push(r),t)),e.filter(t=>!O(t))}async function at(n,e,t,i,r){try{const o=t?Ie(e,t):e,s=z(e);let a;return r||(a=await A(o,s,i)),n.replace(ot(e),`$1${a}$3`)}catch{}return n}function lt(n,{preferredFontFormat:e}){return e?n.replace(rt,t=>{for(;;){const[i,,r]=it.exec(t)||[];if(!r)return"";if(r===e)return`src: ${i};`}}):n}function J(n){return n.search(K)!==-1}async function Q(n,e,t){if(!J(n))return n;const i=lt(n,t);return st(i).reduce((o,s)=>o.then(a=>at(a,s,e,t)),Promise.resolve(i))}async function S(n,e,t){var i;const r=(i=e.style)===null||i===void 0?void 0:i.getPropertyValue(n);if(r){const o=await Q(r,null,t);return e.style.setProperty(n,o,e.style.getPropertyPriority(n)),!0}return!1}async function ct(n,e){await S("background",n,e)||await S("background-image",n,e),await S("mask",n,e)||await S("-webkit-mask",n,e)||await S("mask-image",n,e)||await S("-webkit-mask-image",n,e)}async function pt(n,e){const t=f(n,HTMLImageElement);if(!(t&&!O(n.src))&&!(f(n,SVGImageElement)&&!O(n.href.baseVal)))return;const i=t?n.src:n.href.baseVal,r=await A(i,z(i),e);await new Promise((o,s)=>{n.onload=o,n.onerror=e.onImageErrorHandler?(...l)=>{try{o(e.onImageErrorHandler(...l))}catch(b){s(b)}}:s;const a=n;a.decode&&(a.decode=o),a.loading==="lazy"&&(a.loading="eager"),t?(n.srcset="",n.src=r):n.href.baseVal=r})}async function dt(n,e){const i=w(n.childNodes).map(r=>Z(r,e));await Promise.all(i).then(()=>n)}async function Z(n,e){f(n,Element)&&(await ct(n,e),await pt(n,e),await dt(n,e))}function ht(n,e){const{style:t}=n;e.backgroundColor&&(t.backgroundColor=e.backgroundColor),e.width&&(t.width=`${e.width}px`),e.height&&(t.height=`${e.height}px`);const i=e.style;return i!=null&&Object.keys(i).forEach(r=>{t[r]=i[r]}),n}const ee={};async function te(n){let e=ee[n];if(e!=null)return e;const i=await(await fetch(n)).text();return e={url:n,cssText:i},ee[n]=e,e}async function ne(n,e){let t=n.cssText;const i=/url\(["']?([^"')]+)["']?\)/g,o=(t.match(/url\([^)]+\)/g)||[]).map(async s=>{let a=s.replace(i,"$1");return a.startsWith("https://")||(a=new URL(a,n.url).href),X(a,e.fetchRequestInit,({result:l})=>(t=t.replace(s,`url(${l})`),[s,l]))});return Promise.all(o).then(()=>t)}function ie(n){if(n==null)return[];const e=[],t=/(\/\*[\s\S]*?\*\/)/gi;let i=n.replace(t,"");const r=new RegExp("((@.*?keyframes [\\s\\S]*?){([\\s\\S]*?}\\s*?)})","gi");for(;;){const l=r.exec(i);if(l===null)break;e.push(l[0])}i=i.replace(r,"");const o=/@import[\s\S]*?url\([^)]*\)[\s\S]*?;/gi,s="((\\s*?(?:\\/\\*[\\s\\S]*?\\*\\/)?\\s*?@media[\\s\\S]*?){([\\s\\S]*?)}\\s*?})|(([\\s\\S]*?){([\\s\\S]*?)})",a=new RegExp(s,"gi");for(;;){let l=o.exec(i);if(l===null){if(l=a.exec(i),l===null)break;o.lastIndex=a.lastIndex}else a.lastIndex=o.lastIndex;e.push(l[0])}return e}async function bt(n,e){const t=[],i=[];return n.forEach(r=>{if("cssRules"in r)try{w(r.cssRules||[]).forEach((o,s)=>{if(o.type===CSSRule.IMPORT_RULE){let a=s+1;const l=o.href,b=te(l).then(p=>ne(p,e)).then(p=>ie(p).forEach(g=>{try{r.insertRule(g,g.startsWith("@import")?a+=1:r.cssRules.length)}catch(E){console.error("Error inserting rule from remote css",{rule:g,error:E})}})).catch(p=>{console.error("Error loading remote css",p.toString())});i.push(b)}})}catch(o){const s=n.find(a=>a.href==null)||document.styleSheets[0];r.href!=null&&i.push(te(r.href).then(a=>ne(a,e)).then(a=>ie(a).forEach(l=>{s.insertRule(l,s.cssRules.length)})).catch(a=>{console.error("Error loading remote stylesheet",a)})),console.error("Error inlining remote css file",o)}}),Promise.all(i).then(()=>(n.forEach(r=>{if("cssRules"in r)try{w(r.cssRules||[]).forEach(o=>{t.push(o)})}catch(o){console.error(`Error while reading CSS rules from ${r.href}`,o)}}),t))}function ut(n){return n.filter(e=>e.type===CSSRule.FONT_FACE_RULE).filter(e=>J(e.style.getPropertyValue("src")))}async function mt(n,e){if(n.ownerDocument==null)throw new Error("Provided element is not within a Document");const t=w(n.ownerDocument.styleSheets),i=await bt(t,e);return ut(i)}function re(n){return n.trim().replace(/["']/g,"")}function gt(n){const e=new Set;function t(i){(i.style.fontFamily||getComputedStyle(i).fontFamily).split(",").forEach(o=>{e.add(re(o))}),Array.from(i.children).forEach(o=>{o instanceof HTMLElement&&t(o)})}return t(n),e}async function ft(n,e){const t=await mt(n,e),i=gt(n);return(await Promise.all(t.filter(o=>i.has(re(o.style.fontFamily))).map(o=>{const s=o.parentStyleSheet?o.parentStyleSheet.href:null;return Q(o.cssText,s,e)}))).join(`
`)}async function xt(n,e){const t=e.fontEmbedCSS!=null?e.fontEmbedCSS:e.skipFonts?null:await ft(n,e);if(t){const i=document.createElement("style"),r=document.createTextNode(t);i.appendChild(r),n.firstChild?n.insertBefore(i,n.firstChild):n.appendChild(i)}}async function yt(n,e={}){const{width:t,height:i}=W(n,e),r=await I(n,e,!0);return await xt(r,e),await Z(r,e),ht(r,e),await Ue(r,t,i)}async function vt(n,e={}){const{width:t,height:i}=W(n,e),r=await yt(n,e),o=await P(r),s=document.createElement("canvas"),a=s.getContext("2d"),l=e.pixelRatio||Be(),b=e.canvasWidth||t,p=e.canvasHeight||i;return s.width=b*l,s.height=p*l,e.skipAutoScale||ze(s),s.style.width=`${b}`,s.style.height=`${p}`,e.backgroundColor&&(a.fillStyle=e.backgroundColor,a.fillRect(0,0,s.width,s.height)),a.drawImage(o,0,0,s.width,s.height),s}async function wt(n,e={}){return(await vt(n,e)).toDataURL()}async function Et(n,e){const t=await fetch(`${n.replace(/\/$/,"")}/screenshot/task`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:e.url,x:e.x,y:e.y,viewport:{width:e.viewportWidth??window.innerWidth,height:e.viewportHeight??window.innerHeight},delay_ms:e.delay??1500,crop_size:{width:480,height:320},format:"jpeg"})});if(!t.ok){const s=await t.json().catch(()=>({}));throw new Error(s.detail??`Server error ${t.status}`)}const i=await t.arrayBuffer(),r=new Uint8Array(i);let o="";for(let s=0;s<r.byteLength;s++)o+=String.fromCharCode(r[s]);return`data:image/jpeg;base64,${btoa(o)}`}async function kt(n){let e=n,t=n.parentElement;for(;t&&t.tagName!=="BODY";){const i=t.getBoundingClientRect();if(i.width>=200&&i.height>=60){e=t;break}t=t.parentElement}try{const i=await wt(e,{cacheBust:!0,pixelRatio:1,skipFonts:!1,filter:r=>{var o;return!((o=r.hasAttribute)!=null&&o.call(r,"data-punchbug-ignore"))&&r.id!=="punchbug-root"}});return{full:i,thumb:i}}catch{return{full:"",thumb:""}}}const Ct=`
...
`;class St{constructor(e){if(this.picker=null,this.isPicking=!1,this.columns=[],this.tags=[],this.projectId="",this.pinCleanups=[],this.ghostPin=null,this.config=e,this.hostEl=document.createElement("div"),this.hostEl.id="punchbug-root",this.hostEl.setAttribute("data-punchbug-ignore","true"),document.body.appendChild(this.hostEl),!document.getElementById("pb-global-styles")){const i=document.createElement("style");i.id="pb-global-styles",i.textContent=`
    ...
    `,this.shadow.appendChild(this.triggerBtn),this.triggerBtn.addEventListener("click",()=>this.toggle()),this.taskPanel=new Ee(this.shadow),this.fetchColumns(),this.fetchTags(),this.fetchPageTasks()}async fetchColumns(){try{const e=await fetch(`${this.config.apiUrl}/api/embed/columns?key=${encodeURIComponent(this.config.embedKey)}`);e.ok&&(this.columns=await e.json())}catch{}}async fetchTags(){try{const e=await fetch(`${this.config.apiUrl}/api/embed/tags?key=${encodeURIComponent(this.config.embedKey)}`);e.ok&&(this.tags=await e.json())}catch{}}async fetchPageTasks(){try{const e=encodeURIComponent(window.location.href),t=await fetch(`${this.config.apiUrl}/api/embed/tasks?key=${encodeURIComponent(this.config.embedKey)}&pageUrl=${e}`);if(!t.ok)return;const i=await t.json();this.projectId=i.projectId,this.createPins(i.tasks)}catch{}}createPins(e){this.pinCleanups.forEach(t=>t()),this.pinCleanups=[];for(const t of e)if(t.pinX!==null&&t.pinY!==null)this.createPinAtCoords(t);else if(t.domSelector)try{const i=document.querySelector(t.domSelector);i&&this.createPinOnElement(i,t)}catch{}}createPinAtCoords(e){const t=this.buildPin(e.taskNumber);t.style.position="absolute",t.style.top=`${(e.pinY??0)-11}px`,t.style.left=`${(e.pinX??0)-11}px`,document.body.appendChild(t),t.addEventListener("click",i=>{i.stopPropagation(),this.taskPanel.show(e,this.projectId,this.config.apiUrl,this.config.embedKey)}),this.pinCleanups.push(()=>t.remove())}createPinOnElement(e,t){const i=this.buildPin(t.taskNumber);i.style.position="absolute",document.body.appendChild(i);const r=()=>{const o=e.getBoundingClientRect();i.style.top=`${o.top+window.scrollY-11}px`,i.style.left=`${o.right+window.scrollX-11}px`};r(),window.addEventListener("scroll",r,{passive:!0}),window.addEventListener("resize",r,{passive:!0}),i.addEventListener("click",o=>{o.stopPropagation(),this.taskPanel.show(t,this.projectId,this.config.apiUrl,this.config.embedKey)}),this.pinCleanups.push(()=>{window.removeEventListener("scroll",r),window.removeEventListener("resize",r),i.remove()})}buildPin(e){const t=document.createElement("button");return t.setAttribute("data-punchbug-ignore","true"),t.textContent=String(e),t.style.cssText="z-index:2147483644;background:hsl(348,100%,52%);color:#fff;border:2.5px solid #fff;border-radius:50%;width:24px;height:24px;font-size:10px;font-weight:700;cursor:pointer;display:flex;align-items:center;justify-content:center;padding:0;box-shadow:0 2px 8px rgba(0,0,0,0.4);font-family:sans-serif;line-height:1;transition:transform 0.15s,background 0.15s;",t.onmouseenter=()=>{t.style.transform="scale(1.25)",t.style.background="hsl(348,100%,42%)"},t.onmouseleave=()=>{t.style.transform="",t.style.background="hsl(348,100%,52%)"},t}showGhostPin(e,t){this.removeGhostPin();const i=document.createElement("div");i.setAttribute("data-punchbug-ignore","true"),i.innerHTML=`
      ...
      </svg>`,i.style.cssText=`position:absolute;top:${t-32}px;left:${e-14}px;z-index:2147483644;pointer-events:none;filter:drop-shadow(0 3px 6px rgba(0,0,0,0.4));animation:pb-pin-drop 0.25s cubic-bezier(0.34,1.56,0.64,1);`,document.body.appendChild(i),this.ghostPin=i}removeGhostPin(){var e;(e=this.ghostPin)==null||e.remove(),this.ghostPin=null}refreshPins(){this.fetchPageTasks()}toggle(){this.isPicking?this.stopPicking():this.startPicking()}startPicking(){this.isPicking=!0,this.triggerBtn.classList.add("pb-active"),this.triggerBtn.title="Click anywhere — Esc to cancel";const e=this.triggerBtn.querySelector("span");e&&(e.textContent="Cancel"),this.picker=new fe(t=>this.onPicked(t),()=>this.stopPicking()),this.picker.start()}stopPicking(){var t;this.isPicking=!1,this.triggerBtn.classList.remove("pb-active"),this.triggerBtn.title="Report a task";const e=this.triggerBtn.querySelector("span");e&&(e.textContent="Report"),(t=this.picker)==null||t.stop(),this.picker=null}async onPicked({el:e,pageX:t,pageY:i}){this.stopPicking(),this.showGhostPin(t,i);const r=new ye(this.shadow,{domInfo:ke(e),browserMeta:Se(),pageUrl:window.location.href,pinX:t,pinY:i,embedKey:this.config.embedKey,apiUrl:this.config.apiUrl,columns:this.columns,tags:this.tags,reporterName:this.config.reporterName,onSuccess:()=>{this.removeGhostPin(),this.refreshPins()},onClose:()=>this.removeGhostPin()});this.captureScreenshot(e,t,i).then(({full:o,thumb:s})=>r.setScreenshot(o,s)).catch(()=>r.setScreenshot(""))}async captureScreenshot(e,t,i){const r=this.config.screenshotServerUrl;if(r)try{const o=await Et(r,{url:window.location.href,x:t,y:i,viewportWidth:window.innerWidth,viewportHeight:window.innerHeight});return{full:o,thumb:o}}catch(o){console.warn("PunchBug: screenshot server failed, falling back",o)}return kt(e)}}async function $t(n,e){try{const i=`${new URL(n).origin}/api/embed/auth-check?key=${encodeURIComponent(e)}`,r=await fetch(i,{credentials:"include"});if(!r.ok)return{allowed:!1};const o=await r.json();return{allowed:o.allowed===!0,userName:o.userName||void 0}}catch{return{allowed:!1}}}async function oe(){const n=document.querySelectorAll("script[data-key]");let e=null;if(document.currentScript&&document.currentScript.dataset.key?e=document.currentScript:n.length>0&&(e=n[n.length-1]),!e){console.warn("PunchBug: No script tag with data-key found.");return}const t=e.dataset.key,i=e.dataset.position||"right",r=e.dataset.apiUrl||Lt(),o=e.dataset.screenshotServer||void 0;if(!t){console.warn("PunchBug: data-key attribute is required.");return}const{allowed:s,userName:a}=await $t(r,t);s&&new St({embedKey:t,apiUrl:r,position:i,reporterName:a,screenshotServerUrl:o})}function Lt(){const n=document.querySelectorAll("script[src*='punchbug']");if(n.length>0){const e=n[0].src;try{return new URL(e).origin}catch{}}return"https://punchteam.com"}function se(){const n=new URLSearchParams(window.location.search).get("pb_element");if(n)try{let e=function(){const r=t.getBoundingClientRect();i.style.top=r.top+"px",i.style.left=r.left+"px",i.style.width=r.width+"px",i.style.height=r.height+"px"};const t=document.querySelector(n);if(!t)return;t.scrollIntoView({block:"center",behavior:"smooth"});const i=document.createElement("div");i.setAttribute("data-punchbug-ignore","true"),i.style.cssText="position:fixed;pointer-events:none;z-index:2147483645;box-shadow:0 0 0 3px #3b82f6,0 0 0 8px rgba(59,130,246,0.2);border-radius:3px;transition:opacity 0.4s ease",document.body.appendChild(i),e(),window.addEventListener("scroll",e,{passive:!0}),window.addEventListener("resize",e,{passive:!0}),setTimeout(()=>{i.style.opacity="0",setTimeout(()=>{i.remove(),window.removeEventListener("scroll",e),window.removeEventListener("resize",e)},400)},4e3)}catch{}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{se(),oe()}):(se(),oe())})();
