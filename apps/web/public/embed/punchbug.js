(function(){"use strict";class ye{constructor(e,t){this.hoveredEl=null,this.highlightOverlay=null,this.onPick=e,this.onCancel=t,this.handleMouseOver=this.handleMouseOver.bind(this),this.handleMouseOut=this.handleMouseOut.bind(this),this.handleClick=this.handleClick.bind(this),this.handleKeyDown=this.handleKeyDown.bind(this)}start(){document.body.classList.add("pb-picking-active"),document.addEventListener("mouseover",this.handleMouseOver,!0),document.addEventListener("mouseout",this.handleMouseOut,!0),document.addEventListener("click",this.handleClick,!0),document.addEventListener("keydown",this.handleKeyDown,!0)}stop(){document.body.classList.remove("pb-picking-active"),document.removeEventListener("mouseover",this.handleMouseOver,!0),document.removeEventListener("mouseout",this.handleMouseOut,!0),document.removeEventListener("click",this.handleClick,!0),document.removeEventListener("keydown",this.handleKeyDown,!0),this.clearHighlight()}highlight(e){if(this.clearHighlight(),e.closest("#punchbug-root"))return;this.hoveredEl=e;const t=e.getBoundingClientRect(),i=document.createElement("div");i.id="pb-highlight-overlay",i.setAttribute("data-punchbug-ignore","true"),i.style.cssText=["position:fixed",`top:${t.top}px`,`left:${t.left}px`,`width:${t.width}px`,`height:${t.height}px`,"pointer-events:none","z-index:2147483645","outline:2px solid hsl(348,100%,52%)","outline-offset:2px","border-radius:2px","background:hsla(348,100%,52%,0.07)","box-sizing:border-box"].join(";"),document.body.appendChild(i),this.highlightOverlay=i}clearHighlight(){var e;(e=this.highlightOverlay)==null||e.remove(),this.highlightOverlay=null,this.hoveredEl=null}handleMouseOver(e){const t=e.target;t&&!t.closest("#punchbug-root")&&t!==this.highlightOverlay&&this.highlight(t)}handleMouseOut(e){this.hoveredEl===e.target&&this.clearHighlight()}handleClick(e){e.preventDefault(),e.stopPropagation();const t=e.target;t&&!t.closest("#punchbug-root")&&t!==this.highlightOverlay&&(this.clearHighlight(),this.stop(),this.onPick({el:t,clientX:e.clientX,clientY:e.clientY,pageX:e.clientX+window.scrollX,pageY:e.clientY+window.scrollY}))}handleKeyDown(e){e.key==="Escape"&&(this.stop(),this.onCancel())}}async function we(n,e){const t=await fetch(`${n}/api/embed/report`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)});if(!t.ok){const i=await t.json().catch(()=>({}));throw new Error(i.error||"Failed to submit report")}return t.json()}class ve{constructor(e,t){this.screenshotFull="",this.shadow=e,this.opts=t,this.overlay=this.render(t)}setScreenshot(e,t){var a;this.screenshotFull=e;const i=this.shadow.getElementById("pb-sc-loader"),s=this.shadow.getElementById("pb-sc-wrap"),o=this.shadow.getElementById("pb-sc-img");if(!e){i==null||i.remove();return}const r=t||e;o&&(o.src=r),i&&(i.style.display="none"),s&&(s.style.display="block"),e&&((a=this.shadow.getElementById("pb-sc-expand"))==null||a.addEventListener("click",()=>{this.openLightbox(e)}))}render(e){var b;const t=document.createElement("div");t.className="pb-overlay";const i=document.createElement("div");i.className="pb-panel";const s=document.createElement("div");s.className="pb-panel-header",s.innerHTML=`
    ...
    `,i.appendChild(s),i.appendChild(o),t.appendChild(i),this.shadow.appendChild(t);const a=()=>this.close(e.onClose);(b=this.shadow.getElementById("pb-close"))==null||b.addEventListener("click",a),t.addEventListener("click",p=>{p.target===t&&a()}),this.shadow.querySelectorAll(".pb-tag-pill").forEach(p=>{p.style.opacity="0.55",p.addEventListener("click",()=>{const g=this.shadow.querySelector(`.pb-tag-cb[value="${p.dataset.tagId}"]`);g&&(g.checked=!g.checked,p.style.opacity=g.checked?"1":"0.55",p.style.fontWeight=g.checked?"600":"400")})});const l=this.shadow.getElementById("pb-submit");return l==null||l.addEventListener("click",async()=>{var R,M,B;const p=this.shadow.getElementById("pb-title").value.trim();if(!p){this.shadow.getElementById("pb-title").focus();return}const g=this.shadow.getElementById("pb-desc").value.trim(),k=this.shadow.getElementById("pb-priority").value,F=e.columns.length>0?this.shadow.getElementById("pb-column").value:void 0,y=e.tags.length>0?Array.from(this.shadow.querySelectorAll(".pb-tag-cb:checked")).map(w=>w.value):[];l.disabled=!0,l.textContent="Submitting…";try{const w=this.screenshotFull.startsWith("http");await we(e.apiUrl,{embedKey:e.embedKey,title:p,description:g||void 0,priority:k,screenshot:w?void 0:this.screenshotFull,screenshotUrl:w?this.screenshotFull:void 0,domSelector:e.domInfo.selector,domHtml:e.domInfo.outerHtml,pageUrl:e.pageUrl,columnId:F,tagIds:y.length>0?y:void 0,reporterName:e.reporterName,browserMeta:e.browserMeta,pinX:e.pinX,pinY:e.pinY}),this.shadow.getElementById("pb-report-form").style.display="none",this.shadow.getElementById("pb-success").style.display="block",(R=this.shadow.getElementById("pb-sc-loader"))==null||R.remove(),(M=this.shadow.getElementById("pb-sc-wrap"))==null||M.remove(),(B=e.onSuccess)==null||B.call(e),setTimeout(()=>this.close(),3e3)}catch(w){l.disabled=!1,l.textContent="Submit Task",alert("Failed to submit: "+(w instanceof Error?w.message:"Unknown error"))}}),t}openLightbox(e){const t=document.createElement("div");t.className="pb-lightbox";const i=document.createElement("img");i.className="pb-lightbox-img",i.src=e;const s=document.createElement("button");s.className="pb-lightbox-close",s.innerHTML="&#x2715;",s.addEventListener("click",()=>t.remove()),t.addEventListener("click",o=>{o.target===t&&t.remove()}),t.appendChild(s),t.appendChild(i),this.shadow.appendChild(t)}close(e){this.overlay.remove(),e==null||e()}}const ke={LOW:"#64748b",MEDIUM:"#f59e0b",HIGH:"#f97316",CRITICAL:"#ef4444"},Ee=["LOW","MEDIUM","HIGH","CRITICAL"];function W(n){const e=Date.now()-new Date(n).getTime(),t=Math.floor(e/6e4);if(t<1)return"just now";if(t<60)return`${t}m ago`;const i=Math.floor(t/60);return i<24?`${i}h ago`:`${Math.floor(i/24)}d ago`}function h(n){return n.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}class Ce{constructor(e){this.overlay=null,this.shadow=e}show(e,t,i,s){var b;this.close();const o=document.createElement("div");o.className="pb-overlay";const r=document.createElement("div");r.className="pb-panel";const a=document.createElement("div");a.className="pb-panel-header",a.innerHTML=`
    ...
    `,r.appendChild(a),r.appendChild(l),o.appendChild(r),this.shadow.appendChild(o),this.overlay=o,(b=this.shadow.getElementById("pb-tpanel-close"))==null||b.addEventListener("click",()=>this.close()),o.addEventListener("click",p=>{p.target===o&&this.close()}),Promise.all([fetch(`${i}/api/embed/task/${e.id}?key=${encodeURIComponent(s)}`).then(p=>p.ok?p.json():Promise.reject()),fetch(`${i}/api/embed/columns?key=${encodeURIComponent(s)}`).then(p=>p.ok?p.json():[]),fetch(`${i}/api/embed/members?key=${encodeURIComponent(s)}`).then(p=>p.ok?p.json():[])]).then(([p,g,k])=>{this.renderFull(l,p,g,k,t,i,s)}).catch(()=>this.renderBasic(l,e,t,i))}async patch(e,t,i,s){return fetch(`${e}/api/embed/task/${t}?key=${encodeURIComponent(i)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify(s)})}renderFull(e,t,i,s,o,r,a){var ue,me,ge,fe,xe;const l=t.creatorName||t.guestName||"Guest",b=t.projectSlug??o,p=i.map(c=>`<option value="${h(c.id)}"${c.id===t.columnId?" selected":""}>${h(c.name)}</option>`).join(""),g=Ee.map(c=>`<option value="${c}"${c===t.priority?" selected":""}>${c}</option>`).join(""),k=[`<option value=""${t.assigneeId?"":" selected"}>Unassigned</option>`,...s.map(c=>`<option value="${h(c.id)}"${c.id===t.assigneeId?" selected":""}>${h(c.name??c.id)}</option>`)].join(""),F=t.screenshotUrl?`
      <div>
    ...
    `;const w=this.shadow.getElementById("pb-title-display"),ce=this.shadow.getElementById("pb-title-wrap");let z=t.title;w.addEventListener("click",()=>{const c=document.createElement("input");c.type="text",c.className="pb-title-input",c.value=z,ce.replaceChildren(c),c.focus();const u=async()=>{const d=c.value.trim()||z;z=d;const m=document.createElement("h2");m.className="pb-title-display",m.id="pb-title-display",m.textContent=d,ce.replaceChildren(m),m.addEventListener("click",()=>u()),d!==t.title&&await this.patch(r,t.id,a,{title:d})};c.addEventListener("blur",u),c.addEventListener("keydown",d=>{d.key==="Enter"&&(d.preventDefault(),c.blur()),d.key==="Escape"&&(c.value=z,c.blur())})});const pe=this.shadow.getElementById("pb-desc-display"),de=this.shadow.getElementById("pb-desc-wrap");let D=t.description??"";pe.addEventListener("click",()=>{const c=document.createElement("textarea");c.className="pb-desc-textarea",c.value=D,c.rows=4,de.replaceChildren(c),c.focus();const u=async()=>{const d=c.value;D=d;const m=document.createElement("div");m.className="pb-desc-display",m.id="pb-desc-display",d?(m.style.whiteSpace="pre-wrap",m.textContent=d):m.innerHTML='<span class="pb-desc-placeholder">Click to add a description…</span>',de.replaceChildren(m),m.addEventListener("click",()=>pe.click()),d!==(t.description??"")&&await this.patch(r,t.id,a,{description:d||null})};c.addEventListener("blur",u),c.addEventListener("keydown",d=>{d.key==="Escape"&&(c.value=D,c.blur()),d.key==="Enter"&&(d.metaKey||d.ctrlKey)&&c.blur()})}),(ue=this.shadow.getElementById("pb-col-select"))==null||ue.addEventListener("change",c=>{const u=c.target.value;this.patch(r,t.id,a,{columnId:u||null})}),(me=this.shadow.getElementById("pb-pri-select"))==null||me.addEventListener("change",c=>{const u=c.target.value;this.patch(r,t.id,a,{priority:u})}),(ge=this.shadow.getElementById("pb-assignee-select"))==null||ge.addEventListener("change",c=>{const u=c.target.value;this.patch(r,t.id,a,{assigneeId:u||null})}),t.screenshotUrl&&((fe=this.shadow.getElementById("pb-tp-expand"))==null||fe.addEventListener("click",c=>{c.stopPropagation(),this.openLightbox(t.screenshotUrl)}),(xe=this.shadow.getElementById("pb-tp-sc-wrap"))==null||xe.addEventListener("click",()=>{this.openLightbox(t.screenshotUrl)}));const L=this.shadow.getElementById("pb-comment-input"),E=this.shadow.getElementById("pb-post-comment"),N=this.shadow.getElementById("pb-comments-list"),he=this.shadow.getElementById("pb-comments-label");let be=t.comments.length;E==null||E.addEventListener("click",async()=>{const c=L==null?void 0:L.value.trim();if(!(!c||!L)){E.disabled=!0,E.textContent="Posting…";try{const u=await fetch(`${r}/api/embed/task/${t.id}/comments?key=${encodeURIComponent(a)}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({body:c,guestName:l})});if(!u.ok)throw new Error;const d=await u.json();if(L.value="",be++,he&&(he.textContent=`Comments (${be})`),N){const m=N.querySelector(".pb-no-comments");m&&m.remove();const V=document.createElement("div");V.className="pb-comment",V.innerHTML=`
          ...
          `,N.appendChild(V)}}catch{}finally{E.disabled=!1,E.textContent="Post comment"}}})}renderBasic(e,t,i,s){const o=ke[t.priority]??"#64748b";e.innerHTML=`
    ...
    `}openLightbox(e){const t=document.createElement("div");t.className="pb-lightbox";const i=document.createElement("img");i.className="pb-lightbox-img",i.src=e;const s=document.createElement("button");s.className="pb-lightbox-close",s.innerHTML="&#x2715;",s.addEventListener("click",()=>t.remove()),t.addEventListener("click",o=>{o.target===t&&t.remove()}),t.appendChild(s),t.appendChild(i),this.shadow.appendChild(t)}close(){var e;(e=this.overlay)==null||e.remove(),this.overlay=null}}function Se(n){return{selector:$e(n),outerHtml:n.outerHTML.slice(0,2e3)}}function $e(n){var i;const e=[];let t=n;for(;t&&t!==document.body&&t.nodeType===Node.ELEMENT_NODE;){let s=t.tagName.toLowerCase();if(t.id){e.unshift(`#${CSS.escape(t.id)}`);break}const o=(i=t.parentElement)==null?void 0:i.children;if(o&&o.length>1){let r=1;for(let l=0;l<o.length&&o[l]!==t;l++)o[l].tagName===t.tagName&&r++;Array.from(o).filter(l=>l.tagName===t.tagName).length>1&&(s+=`:nth-of-type(${r})`)}if(e.unshift(s),t=t.parentElement,e.length>=6)break}return e.join(" > ")||n.tagName.toLowerCase()}function Le(){const n=navigator.userAgent,{browserName:e,browserVersion:t}=Pe(n),{osName:i,osVersion:s}=Ie(n),o=Te();return{browserName:e,browserVersion:t,osName:i,osVersion:s,deviceType:o,screenWidth:screen.width,screenHeight:screen.height,viewportWidth:window.innerWidth,viewportHeight:window.innerHeight,userAgent:n}}function Pe(n){const e=[{name:"Chrome",pattern:/Chrome\/([0-9.]+)/},{name:"Firefox",pattern:/Firefox\/([0-9.]+)/},{name:"Safari",pattern:/Version\/([0-9.]+).*Safari/},{name:"Edge",pattern:/Edg\/([0-9.]+)/},{name:"Opera",pattern:/OPR\/([0-9.]+)/}];for(const t of e){const i=n.match(t.pattern);if(i)return{browserName:t.name,browserVersion:i[1].split(".")[0]}}return{browserName:"Unknown",browserVersion:""}}function Ie(n){var e,t,i;return/Windows NT 10/.test(n)?{osName:"Windows",osVersion:"10/11"}:/Windows NT/.test(n)?{osName:"Windows",osVersion:"Other"}:/Mac OS X ([0-9_]+)/.test(n)?{osName:"macOS",osVersion:((e=n.match(/Mac OS X ([0-9_]+)/))==null?void 0:e[1].replace(/_/g,"."))??""}:/Android ([0-9.]+)/.test(n)?{osName:"Android",osVersion:((t=n.match(/Android ([0-9.]+)/))==null?void 0:t[1])??""}:/iPhone OS ([0-9_]+)/.test(n)?{osName:"iOS",osVersion:((i=n.match(/iPhone OS ([0-9_]+)/))==null?void 0:i[1].replace(/_/g,"."))??""}:/Linux/.test(n)?{osName:"Linux",osVersion:""}:{osName:"Unknown",osVersion:""}}function Te(){const n=navigator.userAgent;return/Mobi|Android.*Mobile|iPhone|iPod/.test(n)?"mobile":/iPad|Android(?!.*Mobile)/.test(n)?"tablet":"desktop"}function Re(n,e){if(n.match(/^[a-z]+:\/\//i))return n;if(n.match(/^\/\//))return window.location.protocol+n;if(n.match(/^[a-z]+:/i))return n;const t=document.implementation.createHTMLDocument(),i=t.createElement("base"),s=t.createElement("a");return t.head.appendChild(i),t.body.appendChild(s),e&&(i.href=e),s.href=n,s.href}const Me=(()=>{let n=0;const e=()=>`0000${(Math.random()*36**4<<0).toString(36)}`.slice(-4);return()=>(n+=1,`u${e()}${n}`)})();function v(n){const e=[];for(let t=0,i=n.length;t<i;t++)e.push(n[t]);return e}let C=null;function _(n={}){return C||(n.includeStyleProperties?(C=n.includeStyleProperties,C):(C=v(window.getComputedStyle(document.documentElement)),C))}function P(n,e){const i=(n.ownerDocument.defaultView||window).getComputedStyle(n).getPropertyValue(e);return i?parseFloat(i.replace("px","")):0}function Be(n){const e=P(n,"border-left-width"),t=P(n,"border-right-width");return n.clientWidth+e+t}function ze(n){const e=P(n,"border-top-width"),t=P(n,"border-bottom-width");return n.clientHeight+e+t}function q(n,e={}){const t=e.width||Be(n),i=e.height||ze(n);return{width:t,height:i}}function Oe(){let n,e;try{e=process}catch{}const t=e&&e.env?e.env.devicePixelRatio:null;return t&&(n=parseInt(t,10),Number.isNaN(n)&&(n=1)),n||window.devicePixelRatio||1}const x=16384;function Ue(n){(n.width>x||n.height>x)&&(n.width>x&&n.height>x?n.width>n.height?(n.height*=x/n.width,n.width=x):(n.width*=x/n.height,n.height=x):n.width>x?(n.height*=x/n.width,n.width=x):(n.width*=x/n.height,n.height=x))}function I(n){return new Promise((e,t)=>{const i=new Image;i.onload=()=>{i.decode().then(()=>{requestAnimationFrame(()=>e(i))})},i.onerror=t,i.crossOrigin="anonymous",i.decoding="async",i.src=n})}async function Ae(n){return Promise.resolve().then(()=>new XMLSerializer().serializeToString(n)).then(encodeURIComponent).then(e=>`data:image/svg+xml;charset=utf-8,${e}`)}async function He(n,e,t){const i="http://www.w3.org/2000/svg",s=document.createElementNS(i,"svg"),o=document.createElementNS(i,"foreignObject");return s.setAttribute("width",`${e}`),s.setAttribute("height",`${t}`),s.setAttribute("viewBox",`0 0 ${e} ${t}`),o.setAttribute("width","100%"),o.setAttribute("height","100%"),o.setAttribute("x","0"),o.setAttribute("y","0"),o.setAttribute("externalResourcesRequired","true"),s.appendChild(o),o.appendChild(n),Ae(s)}const f=(n,e)=>{if(n instanceof e)return!0;const t=Object.getPrototypeOf(n);return t===null?!1:t.constructor.name===e.name||f(t,e)};function je(n){const e=n.getPropertyValue("content");return`${n.cssText} content: '${e.replace(/'|"/g,"")}';`}function Fe(n,e){return _(e).map(t=>{const i=n.getPropertyValue(t),s=n.getPropertyPriority(t);return`${t}: ${i}${s?" !important":""};`}).join(" ")}function De(n,e,t,i){const s=`.${n}:${e}`,o=t.cssText?je(t):Fe(t,i);return document.createTextNode(`${s}{${o}}`)}function Y(n,e,t,i){const s=window.getComputedStyle(n,t),o=s.getPropertyValue("content");if(o===""||o==="none")return;const r=Me();try{e.className=`${e.className} ${r}`}catch{return}const a=document.createElement("style");a.appendChild(De(r,t,s,i)),e.appendChild(a)}function Ne(n,e,t){Y(n,e,":before",t),Y(n,e,":after",t)}const G="application/font-woff",X="image/jpeg",Ve={woff:G,woff2:G,ttf:"application/font-truetype",eot:"application/vnd.ms-fontobject",png:"image/png",jpg:X,jpeg:X,gif:"image/gif",tiff:"image/tiff",svg:"image/svg+xml",webp:"image/webp"};function We(n){const e=/\.([^./]*?)$/g.exec(n);return e?e[1]:""}function O(n){const e=We(n).toLowerCase();return Ve[e]||""}function _e(n){return n.split(/,/)[1]}function U(n){return n.search(/^(data:)/)!==-1}function qe(n,e){return`data:${e};base64,${n}`}async function K(n,e,t){const i=await fetch(n,e);if(i.status===404)throw new Error(`Resource "${i.url}" not found`);const s=await i.blob();return new Promise((o,r)=>{const a=new FileReader;a.onerror=r,a.onloadend=()=>{try{o(t({res:i,result:a.result}))}catch(l){r(l)}},a.readAsDataURL(s)})}const A={};function Ye(n,e,t){let i=n.replace(/\?.*/,"");return t&&(i=n),/ttf|otf|eot|woff2?/i.test(i)&&(i=i.replace(/.*\//,"")),e?`[${e}]${i}`:i}async function H(n,e,t){const i=Ye(n,e,t.includeQueryParams);if(A[i]!=null)return A[i];t.cacheBust&&(n+=(/\?/.test(n)?"&":"?")+new Date().getTime());let s;try{const o=await K(n,t.fetchRequestInit,({res:r,result:a})=>(e||(e=r.headers.get("Content-Type")||""),_e(a)));s=qe(o,e)}catch(o){s=t.imagePlaceholder||"";let r=`Failed to fetch resource: ${n}`;o&&(r=typeof o=="string"?o:o.message),r&&console.warn(r)}return A[i]=s,s}async function Ge(n){const e=n.toDataURL();return e==="data:,"?n.cloneNode(!1):I(e)}async function Xe(n,e){if(n.currentSrc){const o=document.createElement("canvas"),r=o.getContext("2d");o.width=n.clientWidth,o.height=n.clientHeight,r==null||r.drawImage(n,0,0,o.width,o.height);const a=o.toDataURL();return I(a)}const t=n.poster,i=O(t),s=await H(t,i,e);return I(s)}async function Ke(n,e){var t;try{if(!((t=n==null?void 0:n.contentDocument)===null||t===void 0)&&t.body)return await T(n.contentDocument.body,e,!0)}catch{}return n.cloneNode(!1)}async function Je(n,e){return f(n,HTMLCanvasElement)?Ge(n):f(n,HTMLVideoElement)?Xe(n,e):f(n,HTMLIFrameElement)?Ke(n,e):n.cloneNode(J(n))}const Qe=n=>n.tagName!=null&&n.tagName.toUpperCase()==="SLOT",J=n=>n.tagName!=null&&n.tagName.toUpperCase()==="SVG";async function Ze(n,e,t){var i,s;if(J(e))return e;let o=[];return Qe(n)&&n.assignedNodes?o=v(n.assignedNodes()):f(n,HTMLIFrameElement)&&(!((i=n.contentDocument)===null||i===void 0)&&i.body)?o=v(n.contentDocument.body.childNodes):o=v(((s=n.shadowRoot)!==null&&s!==void 0?s:n).childNodes),o.length===0||f(n,HTMLVideoElement)||await o.reduce((r,a)=>r.then(()=>T(a,t)).then(l=>{l&&e.appendChild(l)}),Promise.resolve()),e}function et(n,e,t){const i=e.style;if(!i)return;const s=window.getComputedStyle(n);s.cssText?(i.cssText=s.cssText,i.transformOrigin=s.transformOrigin):_(t).forEach(o=>{let r=s.getPropertyValue(o);o==="font-size"&&r.endsWith("px")&&(r=`${Math.floor(parseFloat(r.substring(0,r.length-2)))-.1}px`),f(n,HTMLIFrameElement)&&o==="display"&&r==="inline"&&(r="block"),o==="d"&&e.getAttribute("d")&&(r=`path(${e.getAttribute("d")})`),i.setProperty(o,r,s.getPropertyPriority(o))})}function tt(n,e){f(n,HTMLTextAreaElement)&&(e.innerHTML=n.value),f(n,HTMLInputElement)&&e.setAttribute("value",n.value)}function nt(n,e){if(f(n,HTMLSelectElement)){const t=e,i=Array.from(t.children).find(s=>n.value===s.getAttribute("value"));i&&i.setAttribute("selected","")}}function it(n,e,t){return f(e,Element)&&(et(n,e,t),Ne(n,e,t),tt(n,e),nt(n,e)),e}async function st(n,e){const t=n.querySelectorAll?n.querySelectorAll("use"):[];if(t.length===0)return n;const i={};for(let o=0;o<t.length;o++){const a=t[o].getAttribute("xlink:href");if(a){const l=n.querySelector(a),b=document.querySelector(a);!l&&b&&!i[a]&&(i[a]=await T(b,e,!0))}}const s=Object.values(i);if(s.length){const o="http://www.w3.org/1999/xhtml",r=document.createElementNS(o,"svg");r.setAttribute("xmlns",o),r.style.position="absolute",r.style.width="0",r.style.height="0",r.style.overflow="hidden",r.style.display="none";const a=document.createElementNS(o,"defs");r.appendChild(a);for(let l=0;l<s.length;l++)a.appendChild(s[l]);n.appendChild(r)}return n}async function T(n,e,t){return!t&&e.filter&&!e.filter(n)?null:Promise.resolve(n).then(i=>Je(i,e)).then(i=>Ze(n,i,e)).then(i=>it(n,i,e)).then(i=>st(i,e))}const Q=/url\((['"]?)([^'"]+?)\1\)/g,ot=/url\([^)]+\)\s*format\((["']?)([^"']+)\1\)/g,rt=/src:\s*(?:url\([^)]+\)\s*format\([^)]+\)[,;]\s*)+/g;function at(n){const e=n.replace(/([.*+?^${}()|\[\]\/\\])/g,"\\$1");return new RegExp(`(url\\(['"]?)(${e})(['"]?\\))`,"g")}function lt(n){const e=[];return n.replace(Q,(t,i,s)=>(e.push(s),t)),e.filter(t=>!U(t))}async function ct(n,e,t,i,s){try{const o=t?Re(e,t):e,r=O(e);let a;return s||(a=await H(o,r,i)),n.replace(at(e),`$1${a}$3`)}catch{}return n}function pt(n,{preferredFontFormat:e}){return e?n.replace(rt,t=>{for(;;){const[i,,s]=ot.exec(t)||[];if(!s)return"";if(s===e)return`src: ${i};`}}):n}function Z(n){return n.search(Q)!==-1}async function ee(n,e,t){if(!Z(n))return n;const i=pt(n,t);return lt(i).reduce((o,r)=>o.then(a=>ct(a,r,e,t)),Promise.resolve(i))}async function S(n,e,t){var i;const s=(i=e.style)===null||i===void 0?void 0:i.getPropertyValue(n);if(s){const o=await ee(s,null,t);return e.style.setProperty(n,o,e.style.getPropertyPriority(n)),!0}return!1}async function dt(n,e){await S("background",n,e)||await S("background-image",n,e),await S("mask",n,e)||await S("-webkit-mask",n,e)||await S("mask-image",n,e)||await S("-webkit-mask-image",n,e)}async function ht(n,e){const t=f(n,HTMLImageElement);if(!(t&&!U(n.src))&&!(f(n,SVGImageElement)&&!U(n.href.baseVal)))return;const i=t?n.src:n.href.baseVal,s=await H(i,O(i),e);await new Promise((o,r)=>{n.onload=o,n.onerror=e.onImageErrorHandler?(...l)=>{try{o(e.onImageErrorHandler(...l))}catch(b){r(b)}}:r;const a=n;a.decode&&(a.decode=o),a.loading==="lazy"&&(a.loading="eager"),t?(n.srcset="",n.src=s):n.href.baseVal=s})}async function bt(n,e){const i=v(n.childNodes).map(s=>te(s,e));await Promise.all(i).then(()=>n)}async function te(n,e){f(n,Element)&&(await dt(n,e),await ht(n,e),await bt(n,e))}function ut(n,e){const{style:t}=n;e.backgroundColor&&(t.backgroundColor=e.backgroundColor),e.width&&(t.width=`${e.width}px`),e.height&&(t.height=`${e.height}px`);const i=e.style;return i!=null&&Object.keys(i).forEach(s=>{t[s]=i[s]}),n}const ne={};async function ie(n){let e=ne[n];if(e!=null)return e;const i=await(await fetch(n)).text();return e={url:n,cssText:i},ne[n]=e,e}async function se(n,e){let t=n.cssText;const i=/url\(["']?([^"')]+)["']?\)/g,o=(t.match(/url\([^)]+\)/g)||[]).map(async r=>{let a=r.replace(i,"$1");return a.startsWith("https://")||(a=new URL(a,n.url).href),K(a,e.fetchRequestInit,({result:l})=>(t=t.replace(r,`url(${l})`),[r,l]))});return Promise.all(o).then(()=>t)}function oe(n){if(n==null)return[];const e=[],t=/(\/\*[\s\S]*?\*\/)/gi;let i=n.replace(t,"");const s=new RegExp("((@.*?keyframes [\\s\\S]*?){([\\s\\S]*?}\\s*?)})","gi");for(;;){const l=s.exec(i);if(l===null)break;e.push(l[0])}i=i.replace(s,"");const o=/@import[\s\S]*?url\([^)]*\)[\s\S]*?;/gi,r="((\\s*?(?:\\/\\*[\\s\\S]*?\\*\\/)?\\s*?@media[\\s\\S]*?){([\\s\\S]*?)}\\s*?})|(([\\s\\S]*?){([\\s\\S]*?)})",a=new RegExp(r,"gi");for(;;){let l=o.exec(i);if(l===null){if(l=a.exec(i),l===null)break;o.lastIndex=a.lastIndex}else a.lastIndex=o.lastIndex;e.push(l[0])}return e}async function mt(n,e){const t=[],i=[];return n.forEach(s=>{if("cssRules"in s)try{v(s.cssRules||[]).forEach((o,r)=>{if(o.type===CSSRule.IMPORT_RULE){let a=r+1;const l=o.href,b=ie(l).then(p=>se(p,e)).then(p=>oe(p).forEach(g=>{try{s.insertRule(g,g.startsWith("@import")?a+=1:s.cssRules.length)}catch(k){console.error("Error inserting rule from remote css",{rule:g,error:k})}})).catch(p=>{console.error("Error loading remote css",p.toString())});i.push(b)}})}catch(o){const r=n.find(a=>a.href==null)||document.styleSheets[0];s.href!=null&&i.push(ie(s.href).then(a=>se(a,e)).then(a=>oe(a).forEach(l=>{r.insertRule(l,r.cssRules.length)})).catch(a=>{console.error("Error loading remote stylesheet",a)})),console.error("Error inlining remote css file",o)}}),Promise.all(i).then(()=>(n.forEach(s=>{if("cssRules"in s)try{v(s.cssRules||[]).forEach(o=>{t.push(o)})}catch(o){console.error(`Error while reading CSS rules from ${s.href}`,o)}}),t))}function gt(n){return n.filter(e=>e.type===CSSRule.FONT_FACE_RULE).filter(e=>Z(e.style.getPropertyValue("src")))}async function ft(n,e){if(n.ownerDocument==null)throw new Error("Provided element is not within a Document");const t=v(n.ownerDocument.styleSheets),i=await mt(t,e);return gt(i)}function re(n){return n.trim().replace(/["']/g,"")}function xt(n){const e=new Set;function t(i){(i.style.fontFamily||getComputedStyle(i).fontFamily).split(",").forEach(o=>{e.add(re(o))}),Array.from(i.children).forEach(o=>{o instanceof HTMLElement&&t(o)})}return t(n),e}async function yt(n,e){const t=await ft(n,e),i=xt(n);return(await Promise.all(t.filter(o=>i.has(re(o.style.fontFamily))).map(o=>{const r=o.parentStyleSheet?o.parentStyleSheet.href:null;return ee(o.cssText,r,e)}))).join(`
`)}async function wt(n,e){const t=e.fontEmbedCSS!=null?e.fontEmbedCSS:e.skipFonts?null:await yt(n,e);if(t){const i=document.createElement("style"),s=document.createTextNode(t);i.appendChild(s),n.firstChild?n.insertBefore(i,n.firstChild):n.appendChild(i)}}async function vt(n,e={}){const{width:t,height:i}=q(n,e),s=await T(n,e,!0);return await wt(s,e),await te(s,e),ut(s,e),await He(s,t,i)}async function kt(n,e={}){const{width:t,height:i}=q(n,e),s=await vt(n,e),o=await I(s),r=document.createElement("canvas"),a=r.getContext("2d"),l=e.pixelRatio||Oe(),b=e.canvasWidth||t,p=e.canvasHeight||i;return r.width=b*l,r.height=p*l,e.skipAutoScale||Ue(r),r.style.width=`${b}`,r.style.height=`${p}`,e.backgroundColor&&(a.fillStyle=e.backgroundColor,a.fillRect(0,0,r.width,r.height)),a.drawImage(o,0,0,r.width,r.height),r}async function Et(n,e={}){return(await kt(n,e)).toDataURL()}async function Ct(n,e){const t=await fetch(`${n.replace(/\/$/,"")}/screenshot/task`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:e.url,x:e.x,y:e.y,viewport:{width:e.viewportWidth??window.innerWidth,height:e.viewportHeight??window.innerHeight},delay_ms:e.delay??1500,crop_size:{width:480,height:320},format:"jpeg"})});if(!t.ok){const r=await t.json().catch(()=>({}));throw new Error(r.detail??`Server error ${t.status}`)}const i=await t.arrayBuffer(),s=new Uint8Array(i);let o="";for(let r=0;r<s.byteLength;r++)o+=String.fromCharCode(s[r]);return`data:image/jpeg;base64,${btoa(o)}`}async function St(n){let e=n,t=n.parentElement;for(;t&&t.tagName!=="BODY";){const i=t.getBoundingClientRect();if(i.width>=200&&i.height>=60){e=t;break}t=t.parentElement}try{const i=await Et(e,{cacheBust:!0,pixelRatio:1,skipFonts:!1,filter:s=>{var o;return!((o=s.hasAttribute)!=null&&o.call(s,"data-punchbug-ignore"))&&s.id!=="punchbug-root"}});return{full:i,thumb:i}}catch{return{full:"",thumb:""}}}const $t=`
